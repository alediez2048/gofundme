...
const usersBase: Omit<User, "donationIds" | "totalDonated">[] = [
  {
    ...
    avatar: "/assets/avatars/janahan.jpg",
    verified: true,
    joinDate: "2023-06-15",
    socialLinks: [
...
Thank you for helping us build a safer, more prepared community.`,
    ...
    organizerId: "user-1",
    communityId: "comm-1",
    heroImageUrl: "/assets/fundraisers/wildfire-alerts.jpg",
    updates: [
...
**Transparency:** All funds go to equipment and shipping. Labor and coordination are volunteer. We'll publish a full breakdown once the drive closes.`,
    ...
    organizerId: "user-3",
    communityId: "comm-1",
    heroImageUrl: "/assets/fundraisers/firefighter-equipment.jpg",
    updates: [
...
**Why now:** Our community has grown. So has fire risk. Setting this up before the next event saves confusion and stress when every minute counts.`,
    ...
    organizerId: "user-2",
    communityId: "comm-1",
    heroImageUrl: "/assets/fundraisers/evacuation-hub.jpg",
    updates: [
...
**Why now:** Bills are due. Every delay adds stress. Our goal is to get them to a stable place before the next round of statements.`,
    ...
    organizerId: "user-4",
    communityId: "comm-2",
    heroImageUrl: "/assets/fundraisers/martinez-family.jpg",
    updates: [
...
**Why now:** Need is ongoing. The sooner we build this fund, the sooner we can help the next family that gets a difficult diagnosis.`,
    ...
    organizerId: "user-5",
    communityId: "comm-2",
    heroImageUrl: "/assets/fundraisers/cancer-support.jpg",
    updates: [
...
const donationsRaw: Donation[] = [
  ...
  { id: "don-3", amount: 25, donorId: "user-2", fundraiserId: "fund-1", message: "", createdAt: "2024-05-03T09:00:00Z" },
  { id: "don-4", amount: 250, donorId: "user-3", fundraiserId: "fund-1", message: "Proud to support.", createdAt: "2024-05-03T14:00:00Z" },
  { id: "don-5", amount: 75, donorId: "user-8", fundraiserId: "fund-1", message: "", createdAt: "2024-05-04T08:00:00Z" },
  { id: "don-6", amount: 50, donorId: "user-1", fundraiserId: "fund-2", message: "For our firefighters.", createdAt: "2024-05-01T12:00:00Z" },
  { id: "don-7", amount: 100, donorId: "user-6", fundraiserId: "fund-2", message: "", createdAt: "2024-05-02T16:00:00Z" },
  { id: "don-8", amount: 200, donorId: "user-2", fundraiserId: "fund-2", message: "Critical cause.", createdAt: "2024-05-03T10:00:00Z" },
  { id: "don-9", amount: 50, donorId: "user-7", fundraiserId: "fund-2", message: "", createdAt: "2024-05-04T09:00:00Z" },
  { id: "don-10", amount: 25, donorId: "user-4", fundraiserId: "fund-2", message: "", createdAt: "2024-05-05T11:00:00Z" },
  { id: "don-11", amount: 50, donorId: "user-1", fundraiserId: "fund-3", message: "", createdAt: "2024-05-02T08:00:00Z" },
  ...
  { id: "don-13", amount: 50, donorId: "user-3", fundraiserId: "fund-3", message: "", createdAt: "2024-05-03T09:00:00Z" },
  { id: "don-14", amount: 25, donorId: "user-7", fundraiserId: "fund-3", message: "", createdAt: "2024-05-04T10:00:00Z" },
  ...
  { id: "don-17", amount: 50, donorId: "user-6", fundraiserId: "fund-4", message: "", createdAt: "2024-04-27T12:00:00Z" },
  { id: "don-18", amount: 250, donorId: "user-5", fundraiserId: "fund-4", message: "We're with you.", createdAt: "2024-04-28T09:00:00Z" },
  { id: "don-19", amount: 50, donorId: "user-8", fundraiserId: "fund-4", message: "", createdAt: "2024-04-29T14:00:00Z" },
  { id: "don-20", amount: 100, donorId: "user-1", fundraiserId: "fund-4", message: "", createdAt: "2024-04-30T11:00:00Z" },
  { id: "don-21", amount: 25, donorId: "user-2", fundraiserId: "fund-4", message: "", createdAt: "2024-05-01T08:00:00Z" },
  ...
  { id: "don-24", amount: 50, donorId: "user-6", fundraiserId: "fund-5", message: "", createdAt: "2024-05-01T14:00:00Z" },
  { id: "don-25", amount: 200, donorId: "user-8", fundraiserId: "fund-5", message: "Important work.", createdAt: "2024-05-02T09:00:00Z" },
  { id: "don-26", amount: 50, donorId: "user-3", fundraiserId: "fund-5", message: "", createdAt: "2024-05-03T11:00:00Z" },
  { id: "don-27", amount: 100, donorId: "user-1", fundraiserId: "fund-5", message: "", createdAt: "2024-05-04T10:00:00Z" },
  { id: "don-28", amount: 25, donorId: "user-2", fundraiserId: "fund-5", message: "", createdAt: "2024-05-05T12:00:00Z" },
  { id: "don-29", amount: 150, donorId: "user-5", fundraiserId: "fund-5", message: "For everyone fighting.", createdAt: "2024-05-06T08:00:00Z" },
  { id: "don-30", amount: 50, donorId: "user-7", fundraiserId: "fund-5", message: "", createdAt: "2024-05-06T14:00:00Z" },
];
